...
class DefesaSearch extends Defesa
{
    ...
    {
        $query = Defesa::find()->select("j17_aluno.nome as nome_aluno, j17_aluno.curso as curso_aluno , j17_defesa.*")->innerJoin("j17_aluno"," j17_aluno.id = j17_defesa.aluno_id")->orderBy("data DESC");
