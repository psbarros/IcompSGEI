...
<div class="cont-proj-projetos-view">
	...
	<div class=bs-glyphicons>
        ...
        <?= Html::a('<span class="glyphicon glyphicon-file" aria-hidden=true></span> <span class=glyphicon-class>Cadastrar Equipamento</span>',
            ['equipamento/create', 'idProjeto' => $model->id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-list-alt" aria-hidden=true></span> <span class=glyphicon-class>Gerar Cautela</span>',
            ['cautela/create', 'idProjeto' => $model->id], ['class' => 'btn btn-primary']) ?>
	</div>
